...
|-------------------|-------------------|-----------------------------------|
| `social_capital` | numeric | Social capital score                            |
| `abs_mobility`   | numeric | Absolute mobility score                         |
| `rel_mobility`   | numeric | Relative mobility score                         |
| `urban`          | text    | Identifies whether the CZ is `urban` or `rural` |
| `gini`           | numeric | Gini coefficient                                |
